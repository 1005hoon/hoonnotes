...
<Card
  title="COBE"
  desc="5kB WebGL globe lib."
  link="https://github.com/shuding/cobe"
  image="https://repository-images.githubusercontent.com/429536908/62a4e686-8613-4b45-b7bb-fa35b558ae8e"
/>
...
<div className="framed" style={{ "--frame-padding": 0 }}>
  ![](cobe-old.jpeg)
</div>
...
<Card
  title="Spherical Fibonacci Lattice"
  desc="Ref. extremelearning.com.au The lattice is expressed as a sequence of points   in the unit square  . Each point is converted to spherical coordinates (longitude   and latitude   in radians) by the inverse cylindrical equal area projection:  . Appendix"
  image="https://static.observableusercontent.com/thumbnail/e3e87d7b87300bfe07155d86188a6ed08dc585342e09a97d1fb06ecd9402312b.jpg"
  link="https://observablehq.com/@mbostock/spherical-fibonacci-lattice"
/>
...
<Card
  ...
  image="https://i.ytimg.com/vi/kkGeOWYOFoA/maxresdefault.jpg"
  desc="A movie inspired on numbers, geometry and nature, by Cristóbal Vila"
/>
...
<Card
  ...
  desc="Deploy web projects with the best frontend developer experience and highest end-user performance."
