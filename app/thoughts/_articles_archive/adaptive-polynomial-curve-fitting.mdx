export const metadata = {
  ...
  date: "2022.08.31",
  description:
    "A simple way to find a good polynomial regression curve and avoid overfitting.",
};
...
<div className="framed [--frame-background:#6b6c69]">
  ![Old analytics chart with first and last data points
  highlighted](analytics-old-2.png)
</div>
...
<BlockSideTitle
  title={
    <>
      Example dataset: penguin’s bill length vs. depth. (
      <a href="https://allisonhorst.github.io/palmerpenguins">data source</a>)
    </>
  }
>
  <iframe
    src="https://observablehq.com/embed/@shu/plot-regression?cells=RegressionLinear"
    className="max-h-[440px] aspect-[5/4]"
  />
</BlockSideTitle>
...
<figure>
  <iframe
    src="https://observablehq.com/embed/@shu/plot-regression?cells=Regression%2Cviewof+param%2Cequation"
    className="max-h-[555px] aspect-[12/17]"
  />
</figure>
...
<figure>
  <iframe
    className="max-h-[570px] aspect-[12/17]"
    src="https://observablehq.com/embed/@shu/plot-regression?cells=RegressionLinear1%2Cviewof+rOrder%2Cviewof+rData%2Cviewof+rType"
  />
</figure>
...
<figure>
  <iframe
    className="max-h-[608px] aspect-[2/3]"
    src="https://observablehq.com/embed/@shu/plot-regression?cells=Regression1%2Cviewof+orderT%2Cequation2"
  />
</figure>
...
<figure>
  <iframe
    ...
    src="https://observablehq.com/embed/@shu/plot-regression?cells=error"
  />
</figure>
